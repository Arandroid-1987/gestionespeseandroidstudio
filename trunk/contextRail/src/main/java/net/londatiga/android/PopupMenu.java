 ...
 */
public class PopupMenu extends CustomPopupWindow {
	...
	public PopupMenu(View anchor) {
		...
		root		= (ViewGroup) inflater.inflate(R.layout.popup_menu, null);
	...
	private View getActionItem(String title, Drawable icon, OnClickListener listener) {
		LinearLayout container	= (LinearLayout) inflater.inflate(R.layout.popup_menu_item, null);
