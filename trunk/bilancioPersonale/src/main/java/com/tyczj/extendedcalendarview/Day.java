...
public class Day implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2445693221008460949L;
	int startDay;
	int monthEndDay;
	int day;
	int year;
	...
	private class GetEvents extends AsyncTask<Void,Void,Void>{
		...
		protected Void doInBackground(Void... params) {
			...
			String startDate = DateUtils.getDateString(year, month +1, day);
			String endDate = DateUtils.getDateString(year, month +1, day);
