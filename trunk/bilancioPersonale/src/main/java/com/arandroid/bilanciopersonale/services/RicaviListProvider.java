...
public class RicaviListProvider implements RemoteViewsFactory {
	private List<VoceBilancio> listItemList = new LinkedList<VoceBilancio>();
	private Context context = null;
	private String [] currency;
	
	public RicaviListProvider(Context context, Intent intent) {
	...
	private void populateListItem() {
		...
		Collection<Ricavo> spese = RicavoDao.getMostRecentRicavo(db);
	...
	public RemoteViews getViewAt(int position) {
		...
		Intent intent3 = new Intent(context, VisualizzaRicaviActivity.class);
