	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		if (!items.get(position).isSection()) {
			...
			case FAQ:
				...
				text.append("5) Perchè mi chiede l'indirizzo email quando imposto una password di protezione?\n\n");
				text.append("Se dovessi dimenticare o smarrire la password, non potrai più accedere all'applicazione."
						+ " Sarà quindi possibile, per noi, inviarti un'email con la tua password.\n\n");
				text.append("6) Cosa trovo tra le spese recenti / i ricavi recenti?\n\n");
				text.append("Tra le spese ed i ricavi recenti troverai le ultime 10 voci registrate. "
						+ "Se vuoi controllare tutte le spese/ricavi usa la schermata Riepilogo.\n\n");
				text.append("7) Dove sono finite le spese / i ricavi dell'ultimo mese?\n\n");
			...
			case CHANGE_LOG:
				...
				text.append("\n\nVersione 2.1.1: Bug Fix. Introduzione funzionalità di share backup");
				createDialog(title, text.toString());
				break;
			case MARKET_AUTORE:
				myIntent = new Intent(
