 ...
 */
public class ContextRail extends CustomPopupWindow {
	 ...
	 */
	public ContextRail(View anchor) {
		super(anchor);
		...
		root		= (ViewGroup) inflater.inflate(R.layout.context_rail, null);
		...
		mTrack 			= (ViewGroup) root.findViewById(R.id.context_rail);
		animStyle		= ANIM_AUTO;
		animateTrack	= true;
	}
	...
	private View getActionItem(String title, Drawable icon, OnClickListener listener) {
		LinearLayout container	= (LinearLayout) inflater.inflate(R.layout.context_rail_item, null);
