...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener,OnCreateContextMenuListener,
	...
	public interface OnDayClickListener{
		public void onDayClicked(AdapterView<?> adapter, View view, int position, long id, Day day, ArrayList<Day> allDays);
	}
	...
	private void init(){
		...
		TextViewCompat.setTextAppearance(month, android.R.style.TextAppearance_Large);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		if(dayListener != null){
			...
			ArrayList<Day> allDays = mAdapter.getAllDays();
			if(d.getDay() != 0){
				dayListener.onDayClicked(arg0, arg1, arg2, arg3,d, allDays);
			}
		}
	}
